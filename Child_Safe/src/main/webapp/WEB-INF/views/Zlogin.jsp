...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<form action="${cpath}/Zlogin.do" method="post">
				<img src="${pageContext.request.contextPath}/resources/skydash/images/avatar.png" />
				<a href="Zindex.do" class="title">ChildSafe</a>
				...
				<a href="Zjoin.do" class=join style="text-align: right; margin-top: 10px;">회원가입</a> 
				<button class="btn" id="submit">로그인</button>
			</form>
		</div>
	</div>
	<script>
