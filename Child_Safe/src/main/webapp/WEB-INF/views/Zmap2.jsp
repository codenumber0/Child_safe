...
<body>
    <header class="menu menu">
        <div class="title">
            ...
            <button type="button" title="통합지도 검색" class="currentMap" onclick="$('header.menu').toggleClass('on');" id="thisMapTitle">사고지점</button>
    ...
    <main class="map total">
        ...
        <aside class="left">
            ...
            <div id="ca_deaths" >
                <section class="search" style="height: 230px;">
                    <ul class = "tap">
                    <nav class="tab">
                        <li class="current" data-tab="tab1"><button type="button" class="on">사망자</button></li>
                        <li data-tab="tab2"><button type="button">중상자</button></li>
                        <li data-tab="tab3"><button type="button">경상자</button></li>
                        <li data-tab="tab4"><button type="button">부상자</button></li>
                    </nav>
                    </ul>
                    <ul class="condition">
                        ...
                        <li class="0_00_001">
                            ...
                            <select name="month_text_area">
                                <option value="">발생 월</option>
                        ...
                        <li class="0_00_001">
                            <select name="ca_child_yn">
                                <option value="">어린이 사고 여부</option>
                                <option>Y</option>
                                <option>N</option>
                            </select>
                        </li>
            ...
            <div id="ca_serious_injury">
                <section class="search" style="height: 230px;">
                    <ul class = "tap">
                    <nav class="tab">
                        <li class="current" data-tab="tab1"><button type="button" >사망자</button></li>
                        <li data-tab="tab2"><button type="button" class="on" >중상자</button></li>
                        <li data-tab="tab3"><button type="button">경상자</button></li>
                        <li data-tab="tab4"><button type="button" class="long">부상자</button></li>
                    </nav>  
                    </ul>
                    <ul class="condition">
                        <li class="0_00_002">
            ...
            <div id="ca_light_injury">
                <section class="search"  style="height: 230px;">
                    <ul class = "tap">
                    <nav class="tab">
                        <li class="current" data-tab="tab1"><button type="button">사망자</button></li>
                        <li data-tab="tab2"><button type="button" >중상자</button></li>
                        <li data-tab="tab3"><button type="button" class="on">경상자</button></li>
                        <li data-tab="tab4"><button type="button" class="long">부상자</button></li>
                    </nav>
                    </ul>
            ...
            <div id="ca_injury">
                <section class="search"  style="height:230px;">
                    ...
                    <nav class="tab">
                        ...
                        <li data-tab="tab2"><button type="button">중상자</button></li>
                        <li data-tab="tab3"><button type="button">경상자</button></li>
                        <li data-tab="tab4"><button type="button" class="long on">부상자</button></li>
                    </nav>
                    </ul>
                    <ul class="condition">
                        <li class="0_00_004">
