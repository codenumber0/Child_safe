...
<html>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/skydash/css/vertical-layout-light/map2.css" type="text/css">
...
<body>
    <header class="menu menu">
        ...
        <nav>
            <button type="button" title="스쿨존 현황" class="total" onclick="location.href = 'map1.html'">스쿨존 현황</button>
            <button type="button" title="사고지점" class="statistics" onclick="location.href = 'map2.html'">어린이 사고지점</button>
            <button type="button" title="어린이 사고 다발지점" class="hdmap" onclick="location.href = 'map3.html'">어린이 사고 다발지점</button>
            <button type="button" title="어린이 인구 밀도" class="north" onclick="location.href = 'map4.html'">어린이 인구 밀도</button>
        </nav>
    </header>
